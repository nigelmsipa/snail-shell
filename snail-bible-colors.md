...
> Note: MLV (Modern Literal Version) isn't placed yet — when added, slot it by
> its publication year and read the hue off the gradient between its neighbors.
> Same rule, no new decisions needed.
